...
class TestPopulation:
    ...
    def test_process_signals_returns_all_bots(self) -> None:
        pop = Population(5, _paper_config(), _fitness_config(), _genetics_config(), 100)
    ...
    def test_evolution_trigger(self) -> None:
        pop = Population(5, _paper_config(), _fitness_config(), _genetics_config(), 3)
    ...
    def test_bot_fitness_metrics(self) -> None:
        pop = Population(3, _paper_config(), _fitness_config(), _genetics_config(), 100)
